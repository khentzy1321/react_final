...
function EmploEdit() {
     ...
     useEffect(()=>{
          fetch("http://localhost:8000/employee/"+ empid).then((res)=>{
               ...
               // emplochange(resp);
               idchange(resp.id);
               fnamechange(resp.first_name);
               lnamechange(resp.last_name);
               emailchange(resp.email);
               cont_numchange(resp.contact_number);
               actchange(resp.isactive);
          }).then((err)=>{
     ...
     const handlesubmit=(e)=>{
           e.preventDefault();
           const emplodata={id, first_name, last_name, email, contact_number, active};
                         ...
                         <form className="container" onSubmit={handlesubmit}>
                              <div className='card mt-3'>
                                   ...
                                   <div className="card-body">
                                        ...
                                        <div className='form-group btnedit'>
